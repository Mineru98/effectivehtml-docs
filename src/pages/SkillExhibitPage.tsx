...
const EXHIBITS = [
  {
    ...
    resultImage: '/assets/skill-results/html.webp',
  ...
  },
  {
    ...
    resultImage: '/assets/skill-results/design-artifact.webp',
  ...
  },
  {
    ...
    resultImage: '/assets/skill-results/html-wireframe.webp',
  ...
  },
  {
    ...
    resultImage: '/assets/skill-results/html-prototype.webp',
  ...
  },
  {
    ...
    resultImage: '/assets/skill-results/html-plan.webp',
  ...
  },
  {
    ...
    resultImage: '/assets/skill-results/html-diagram.webp',
      ...
      <div className="skill-exhibit-grid">
        {EXHIBITS.map((exhibit) => (
          <article className={`skill-exhibit-card tone-${exhibit.tone}`} key={exhibit.name}>
            ...
            <p>{exhibit.answer}</p>
            <div className="skill-exhibit-prompt">
              <div className="skill-exhibit-prompt-heading">
                <span>복사할 프롬프트</span>
                <button type="button" onClick={() => void copyPrompt(exhibit.name, exhibit.prompt)}>{copiedSkill === exhibit.name ? '복사됨' : '프롬프트 복사'}</button>
              </div>
